...
public class AdminController {
	...
	public String adminIndex(HttpSession session) {
		...
		if(member == null || "ROLE_MEMBER".equals(member.getRole())) {
			return "errorPage";
		} else {
	...
	public String regProduct(HttpServletRequest request, HttpSession session) {
		Member member = (Member)session.getAttribute("loginMember");
		if(member == null || "ROLE_MEMBER".equals(member.getRole())) {
			return "errorPage";
		} else {
	...
	public String getProductDetail(HttpServletRequest request, Model model, HttpSession session) {
		Member member = (Member)session.getAttribute("loginMember");
		if(member == null || "ROLE_MEMBER".equals(member.getRole())) {
			return "errorPage";
		} else {
	...
	public String productModigyForm(HttpServletRequest request, Model model, HttpSession session) {
		Member member = (Member)session.getAttribute("loginMember");
		if(member == null || "ROLE_MEMBER".equals(member.getRole())) {
			return "errorPage";
		} else {
	...
	public String productModify(HttpServletRequest request, HttpSession session) {
		Member member = (Member)session.getAttribute("loginMember");
		if(member == null || "ROLE_MEMBER".equals(member.getRole())) {
			return "errorPage";
		} else {
	...
	public String productDelete(HttpServletRequest request, HttpSession session) {
		Member member = (Member)session.getAttribute("loginMember");
		if(member == null || "ROLE_MEMBER".equals(member.getRole())) {
			return "errorPage";
		} else {
